...
export default function DocumentLibrary() {
  ...
  return <div className="space-y-6"><div><h1 className="text-2xl font-semibold">Document Library</h1><p className="text-sm text-text-secondary">Upload PDF or DOCX evidence. Maximum 20 MB; identical content is rejected using SHA-256.</p></div><UploadZone onFiles={handleFiles} busy={busy}/>
